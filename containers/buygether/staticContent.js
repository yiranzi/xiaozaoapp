module.exports = [
  {
    ...
    content: '小灶能力学院将会在新技术驱动下，不断迭代已有的系统学、打卡学的使用体验和学习效果，也将探索更高效的学习模式，确保同学们能够最大化地吸收知识，掌握技能。目前，小灶能力学院主要有系统学（重规划、重输出）和 打卡学（有监督、重积累） 两类学习模式。两者均可以在移动端和 PC 端学习，反复学习、有教学视频、有作业、有讨论、有拓展阅读等。'
  },
  {
    question: '2.课程什么时候上线可以看呀？',
    content: '12项能力课程会在2018年逐月上线，最早一门会在2018年1月5日即开放兑换。请小伙伴务必关注“小灶能力派服务号”（微信搜索“小灶能力派服务号”），我们会及时通过服务号的“模版消息”通知各位小伙伴！'
  },
  {
    question: '3.课程什么时候上线可以看呀？',
  ...
  },
  {
    ...
    content: '能力卡有效期为2018年1月1日-2018年12月31日，同学可以根据自己的兴趣和需求选择需要的课程，使用学习卡进行开通，学习卡仅限本人使用哦'
  },
  {
