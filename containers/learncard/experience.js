    ...
    return (
      <div className='experience'>
        <section>
          ...
          <img src='/static/img/learncard/01.jpg' />
        ...
        <section>
          ...
          <img src='/static/img/learncard/02.jpg' />
          ...
          <div className='btn'><a href='https://www.xiaozao.org/learn/course/34'><Button text='立即体验' bg='#218ee9' /></a></div>
        </section>
        <section>
