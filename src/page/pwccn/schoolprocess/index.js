    ...
    render() {
        return (
            <div className="main-section">
                ...
                <SchoolNav fromType="school" processLink="/schoolassistantpwccn/schoolprocess" workLink="/schoolassistantpwccn/schoolWork" expLink="/schoolassistantpwccn/schoolExp"/>
