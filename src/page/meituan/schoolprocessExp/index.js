  ...
  constructor (props) {
    ...
    this.state = {
      list: [
        ...
        {title: '在迷茫与浮躁中前行——致我的校招季(美团点评产品运营）', link: 'http://bbs.yingjiesheng.com/forum.php?mod=viewthread&tid=2070664&extra=page%3D1%26filter%3Ddigest%26digest%3D1', tag: ['综合经验', '', '', '']},
