...
export default class schoolExp extends React.Component {
    constructor(props) {
        ...
        this.state = {
            list:[
                {title:"2016玛氏箭牌销售培训生求职经验分享",link:"http://bbs.yingjiesheng.com/thread-2020901-1-1.html",tag:["网申","笔试","面试","综合经验"]},
                {title:"从网申到终面",link:"http://bbs.yingjiesheng.com/forum.php?mod=viewthread&tid=2026329&extra=page%3D1%26filter%3Ddigest%26digest%3D1",tag:["网申","笔试","面试","综合经验"]},
                {title:"【签约】开心的箭牌之旅",link:"http://bbs.yingjiesheng.com/forum.php?mod=viewthread&tid=2035240&extra=page%3D1%26filter%3Ddigest%26digest%3D1",tag:["求职","笔试","面试","综合经验"]},
    ...
    render() {
        ...
        return (
            <div className="main-section">
                ...
                <SchoolNav fromType="exp" processLink="/school/mars/schoolprocess/index.html" workLink="/school/mars/schoolWork/index.html" expLink="/school/mars/schoolExp/index.html"/>
