    ...
    return (
      <InterviewLayout isRender={isRender}>
        ...
        <div className='intro-content'>
          ...
          <br/>
          <p>第七天，我们会筛选安排一次在线的群面模拟，为保证群面模拟质量，只有能够连续完成前6天打卡且正确率达到 70%
            以上前的500名同学，才能最终解锁第7天线上模拟群面参与权限。（前500名同学，以做题正确率及做题所用时间作为排名标准，在正确率相同的情况下，以同学们的答题时间为标准，答题时间越短，则排名越靠前）同学们的排名获得参与权限后，获得精选案例材料，在小灶的组织下和同学们进行线上模拟。</p>
          <br/>
